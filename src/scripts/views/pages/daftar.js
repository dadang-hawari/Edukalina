import register from '../../utils/create-account';
      ...
      <div class="register">    
        <form class="flexForm">
                <div class="formRegister">
                    <div class="input" id="inputUsername">
                        <label for="usernameRegist">Username</label><br>
                        <input id="usernameRegist" class="input-register" type="text" placeholder="Masukkan Username" name="Username">
                    </div>
                    <div class="input" id="inputEmail">
                        <label for="emailRegist">Email</label><br>
                        <input id="emailRegist" class="input-register" type="text" placeholder="Masukkan Email" name="Email">
                    </div>
                    <div class="input relative" id="inputPassword">
                        <label for="passwordRegist">Password</label><br>
                        <input id="passwordRegist" class="input-register" type="password" placeholder="Masukkan Password" name="Password">
                        <button id="pwEye" type="button">
